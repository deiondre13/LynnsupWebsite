...
export default function ServicesPage() {
  ...
  return (
    <div className="pt-20">
      ...
      <section aria-labelledby="services-hero-heading" className="relative py-24 md:py-28 bg-gradient-to-br from-primary-base via-primary-contrast to-primary-base text-white overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            >
              ...
              {/* Heading */}
              <h1 id="services-hero-heading" className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 leading-tight">
      ...
      {/* Services Grid — bento layout with primary and wide feature cards */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-start">
            {services.map((service, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className={`relative h-full bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all duration-500 overflow-hidden border border-neutral-light hover:border-accent-gold/50 group-hover:-translate-y-2 ${index === 0 ? 'border-l-4 border-l-accent-gold' : ''}`}>
                  ...
                  <div className="relative px-8 pb-8">
                    ...
                    <div className="w-16 h-16 -mt-9 mb-5 rounded-2xl bg-gradient-to-br from-accent-gold to-accent-amber flex items-center justify-center text-white shadow-lg ring-4 ring-white group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                      {service.icon}
                    </div>
                    ...
                    {/* Divider */}
                    <div className="w-12 h-1 bg-gradient-to-r from-accent-gold to-accent-amber rounded-full mb-6 group-hover:w-full transition-all duration-500" aria-hidden="true"></div>
                        ...
                        {service.features.slice(0, 4).map((feature, idx) => (
                          ...
                          >
                            <div className="w-5 h-5 rounded-full bg-accent-gold/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                              <CheckCircle className="w-3 h-3 text-accent-gold" aria-hidden="true" />
                            </div>
                    ...
                    {/* Hover indicator */}
                    <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-accent-gold via-accent-amber to-accent-gold transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left" aria-hidden="true"></div>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      {/* CTA Section — contained offset panel, distinct from the hero */}
      <section aria-labelledby="services-cta-heading" className="relative py-24 md:py-32 px-4 md:px-8 bg-white overflow-hidden">
        <div className="container-custom relative">
          {/* Offset gold frame behind the panel */}
          <div aria-hidden="true" className="hidden md:block absolute inset-0 translate-x-4 translate-y-4 rounded-3xl border-2 border-accent-gold/30"></div>
            ...
            <div className="relative z-10 px-6 py-14 md:px-14 md:py-20">
              <div className="grid lg:grid-cols-12 gap-12 items-center">
                ...
                >
                  ...
                  <h2 id="services-cta-heading" className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-heading font-bold mb-6 leading-tight">
                    Need a Custom<br />
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.6, delay: 0.2 }}
                  className="lg:col-span-5 bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20 shadow-2xl"
                >
                  <div className="text-center mb-6">
                    <div className="w-16 h-16 bg-accent-gold/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                      <Users className="w-8 h-8 text-accent-gold" aria-hidden="true" />
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <Link
                      href="/contact"
                      className="block w-full text-center bg-accent-gold/20 hover:bg-accent-gold/30 text-white px-6 py-3 rounded-xl font-semibold transition-all border border-accent-gold/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-gold"
                    >
                      Request a Quote
                    </Link>
                  </div>
